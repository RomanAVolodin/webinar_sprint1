...
class MoviesApiMixin(BaseListView):
    ...
    def get_queryset(self):
        ...
        queryset = (
            ...
            .annotate(
                directors=ArrayAgg('personfilmwork__person__full_name', filter=Q(personfilmwork__role='director'))
            )
...
class MoviesListApi(MoviesApiMixin):
    def get_context_data(self, *, object_list=None, **kwargs):
        ...
        return {'count': paginator.count, 'total_pages': int, 'prev': int, 'next': int, 'results': list}
